...
public class StructureController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('STRUCTURE_CREATE') or hasAuthority('ALL_PERMISSIONS')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAuthority('STRUCTURE_VIEW') or hasAuthority('ALL_PERMISSIONS')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('STRUCTURE_UPDATE') or hasAuthority('ALL_PERMISSIONS')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority('STRUCTURE_DELETE') or hasAuthority('ALL_PERMISSIONS')")
