...
public class TransportAttendance {
    ...
    public TransportAttendance(Long id, Long studentId, LocalDate attendanceDate, MarkedBy markedBy, RouteWay route, Vehicle vehicle, PickupStatus pickupStatus, DropStatus dropStatus) {
        this.id = id;
    ...
    public DropStatus getDropStatus() { return dropStatus; }
    public void setDropStatus(DropStatus dropStatus) { this.dropStatus = dropStatus; }
}
