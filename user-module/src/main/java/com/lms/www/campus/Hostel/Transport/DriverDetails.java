...
public class DriverDetails {
    ...
    public DriverDetails(Long driverId, String fullName, String contactNumber, String licenseNumber,
            LocalDate licenseExpiryDate, Role role, ExperienceCategory experienceCategory, Boolean backgroundVerified,
            ShiftType shift, Integer experienceYears, LicenseValidityStatus licenseValidityStatus,
            DriverStatus verificationStatus, Boolean active, Vehicle vehicle, RouteWay route,
    ...
    public Boolean getBackgroundVerified() {
    ...
    public LicenseValidityStatus getLicenseValidityStatus() {
        return licenseValidityStatus;
    }

    public void setLicenseValidityStatus(LicenseValidityStatus licenseValidityStatus) {
        this.licenseValidityStatus = licenseValidityStatus;
    }

    public DriverStatus getVerificationStatus() {
        return verificationStatus;
    }

    public void setVerificationStatus(DriverStatus verificationStatus) {
        this.verificationStatus = verificationStatus;
    }
    ...
    public ConductorDetails getConductor() {
        return conductor;
    }

    public void setConductor(ConductorDetails conductor) {
        this.conductor = conductor;
    }
}
