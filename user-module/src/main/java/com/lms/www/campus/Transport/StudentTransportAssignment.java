...
public class StudentTransportAssignment {
    ...
    @Column(name = "pickup_point", nullable = false, length = 100)
    private String pickupPoint;

    @Column(name = "drop_point", nullable = false, length = 100)
    ...
    public StudentTransportAssignment(Long id, Long studentId, Vehicle vehicle, RouteWay route, String pickupPoint, String dropPoint, Shift shift) {
        this.id = id;
