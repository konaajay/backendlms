...
public class Vehicle {
    ...
    public Vehicle(Long id, String vehicleNumber, VehicleType vehicletype, Integer capacity, Integer occupiedSeats,
            VehicleStatus vehicleStatus, LocalDateTime createdDate, RouteWay route, Boolean gpsEnabled) {
        this.id = id;
