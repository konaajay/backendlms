...
public class VehicleMaintenance {
    ...
    public VehicleMaintenance(Long id, String vehicleId, MaintenanceType type, LocalDate date, Double cost, String description, MaintenanceStatus status, LocalDate nextDue) {
        this.id = id;
