...
public class ExamController {
    ...
    // CREATE
    @PostMapping
    @PreAuthorize("hasAnyAuthority('EXAM_CREATE', 'ROLE_ADMIN', 'ROLE_SUPER_ADMIN', 'ALL_PERMISSIONS', 'ROLE_INSTRUCTOR')")
    ...
    @PreAuthorize("hasAnyAuthority('EXAM_PUBLISH', 'ROLE_ADMIN', 'ROLE_SUPER_ADMIN', 'ALL_PERMISSIONS', 'ROLE_INSTRUCTOR')")
    ...
    @PreAuthorize("hasAnyAuthority('EXAM_CLOSE', 'ROLE_ADMIN', 'ROLE_SUPER_ADMIN', 'ALL_PERMISSIONS', 'ROLE_INSTRUCTOR')")
    ...
    @PreAuthorize("hasAnyAuthority('EXAM_DELETE', 'ROLE_ADMIN', 'ROLE_SUPER_ADMIN', 'ALL_PERMISSIONS')")
    ...
    @PreAuthorize("hasAnyAuthority('EXAM_RESTORE', 'ROLE_ADMIN', 'ROLE_SUPER_ADMIN', 'ALL_PERMISSIONS')")
    ...
    @PreAuthorize("hasAnyAuthority('EXAM_HARD_DELETE', 'ROLE_ADMIN', 'ROLE_SUPER_ADMIN', 'ALL_PERMISSIONS')")
    ...
    @GetMapping("/deleted")
    @PreAuthorize("hasAnyAuthority('EXAM_VIEW', 'ROLE_ADMIN', 'ROLE_SUPER_ADMIN', 'ALL_PERMISSIONS')")
