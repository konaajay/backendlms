...
public class CourseProgressDTO {
    ...
    public CourseProgressDTO(Long courseId, Long batchId, String courseName, String courseDescription, String thumbnail, String instructorName, double progressPercentage, List<TopicDTO> topics) {
    ...
    public static class CourseProgressDTOBuilder {
        ...
        public CourseProgressDTOBuilder batchId(Long batchId) { this.batchId = batchId; return this; }
        ...
        public CourseProgressDTOBuilder thumbnail(String thumbnail) { this.thumbnail = thumbnail; return this; }
        public CourseProgressDTOBuilder instructorName(String instructorName) { this.instructorName = instructorName; return this; }
        ...
        public CourseProgressDTO build() {
            return new CourseProgressDTO(courseId, batchId, courseName, courseDescription, thumbnail, instructorName, progressPercentage, topics);
        }
    }
}